    ...
    >
      ...
      <div className="relative flex-none overflow-hidden rounded-tl-[4px] rounded-tr-[10px]">
        {hasPhoto ? (
          ...
          // Always show the WHOLE scene (person included) at its natural aspect
          // — a wide "slice" crops the man off the right on anything under a very
          // wide screen, so we never slice.
